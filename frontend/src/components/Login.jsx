...
//       >
//         <div>
//           <h1 className="text-center font-bold text-xl mb-10">LOGIN TO SOCIALLY</h1>
//           <p className="text-sm text-center">
//             Log in to see updates from your family & friends
//           </p>
//         </div>
...
const Login = () => {
  ...
  const signUpHandler = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(
        "https://socially-ee6z.onrender.com/api/v1/user/login",
        input,
        {
          headers: {
            "Content-Type": "application/json",
...
>
  ...
  <form
    onSubmit={signUpHandler}
    className="relative bg-white p-8 rounded-lg shadow-xl w-full sm:w-96 max-w-md z-10"
  >
    <div className="text-center mb-6">
      <h1 className="text-3xl font-semibold text-gray-800 mb-5">Login to Socially</h1>
      <p className="text-sm text-gray-600">Log in to see updates from your family & friends</p>
    </div>
    ...
    <div className="text-center">
      <span className="text-sm text-gray-600">
        ...
        <Link to="/signup" className="text-indigo-600 hover:text-indigo-800 transition duration-200">
          Signup
        </Link>
      </span>
    </div>
